...
int main(int argc, char* argv[])
{
  ...
  TBranch *b_pass_Mu8_Ele23= ntuple->Branch("pass_Mu8_Ele23",&pass_Mu8_Ele23,"pass_Mu8_Ele23/I");
  TBranch *b_pass_Mu8_Ele23_DZ= ntuple->Branch("pass_Mu8_Ele23_DZ",&pass_Mu8_Ele23_DZ,"pass_Mu8_Ele23_DZ/I");
...
std::string TriggerList[3] = {"HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v*","HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v*","HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v*"};  
...
//       if((abs(selLeptons[0].pdgId()) == 13 && abs(selLeptons[1].pdgId() == 11)) || (abs(selLeptons[1].pdgId()) == 13 && abs(selLeptons[0].pdgId() == 11))) passOnlyEMu = true; //leading Muon + sub-leading Electron or vice-versa
      ...
      if(abs(selLeptons[0].pdgId()) == 11 && abs(selLeptons[1].pdgId() == 13)) passOnlyEMu = true;
  ...
  //       int second = (first+1)%2;
         ...
         passKinMu = ((abs(ptf) >= 8 && abs(etaf) <= 2.4));
         ...
         passKinEle = ((abs(pts) >= 23 && abs(etas) <= 2.5));     
...
//	 if(!ZPick) continue;	 
	 ...
	 Zmass = mass;
         ...
         bool Ele23Mu8TrigDZ(false),Ele23Mu8Trig(false);

         Ele23Mu8TrigDZ   = utils::passTriggerPatterns(tr, TriggerList[0]);
         Ele23Mu8Trig   = utils::passTriggerPatterns(tr, TriggerList[1]);

//cout << "Trigger Decision = " << Ele23Mu12TrigDZ << "   " << Ele23Mu12Trig << endl;

         if(Ele23Mu8Trig) pass_Mu8_Ele23 = 1;
         if(Ele23Mu8TrigDZ) pass_Mu8_Ele23_DZ = 1;
